...
# plt.figure()
# plt.hist(y_train, edgecolor='black', linewidth=1, bins=range(11), align='left')
# plt.xticks(range(0, 10))
# plt.title("Counts of number of each digit 0-9 in train dataset")
# plt.show()
...
model.save('c:/Users/wybek/Documents/school/Kaggle/Digit_Recognizer/Model/model_2.h5')
